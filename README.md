...
- Login (with Google)
- Land
  - Todos (Simple mode, Advanced mode (Upcoming (Daily, Weekly, Monthly), Annual, Future (Just note)))
    - Add/Edit (Title, Description, Mode, Deadline, Sub tasks, Related habits)
    - History
  - Habits
